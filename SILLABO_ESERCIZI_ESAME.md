...
## 📊 STATO DI AVANZAMENTO E VALUTAZIONE
* **Esercizi Svolti e Consolidati**: **40 / 57** (70.2%)
...
#### [x] 📝 Esercizio C.1.3 (Raccolta Appelli 2021, Esercizio 1 — 10 Punti) — Array Triangolare / Ricerca Picco
...
#### [x] 📝 Esercizio C.2.3 (Problema Bandiera Olandese) — `TriSort(A)`
...
#### [x] 📝 Esercizio C.4.3 (Raccolta Appelli 2020, Esercizio 1 — 9 Punti) — `Anc(T, k1, k2)` (Lowest Common Ancestor - LCA)
...
#### [x] 📝 Esercizio C.4.4 (Raccolta Esercizi, Esercizio 14) — `BST(A)` (Costruzione da Array Ordinato)
...
#### [x] 📝 Esercizio D.6.1 (Appello 31 Gennaio 2024 & Appello 02 Luglio 2024, Esercizio 2 — 10 Punti) — Activity Selection "Inizia per Ultima"
...
#### [x] 📝 Esercizio D.6.2 (Appello 18 Giugno 2025, Esercizio 2 — 9 Punti) — Scheduling Minimizzazione Tempi di Completamento (SPT)
> **Stato**: ⭐ SVOLTO OGGI (29/08) | **Valutazione Reale**: 
*   **Traccia Integrale**:
